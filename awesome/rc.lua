...
globalkeys = gears.table.join(
	awful.key({ modkey }, "s", function()
		awful.spawn("systemsettings")
	end, { description = "open system settings", group = "launcher" }),
...
-- Autostart Nitrogen to restore wallpaper
awful.spawn.with_shell("nitrogen --restore")

-- Picom compositor
awful.spawn.with_shell("pkill picom; picom --backend glx --vsync --config ~/.config/picom/picom.conf")
